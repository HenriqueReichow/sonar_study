...
class Read_sonar_dataset:
    def __init__(self, visualize_pcd = True, mission_dataset_path = "/home/lh/Documents/all_missions/mission-1", distance_filter = True):
        ...
        for n in range(40):
            ...
            for k in range(1,500):
                    try:
                        ...
                        mask_points = dados > np.max(dados) * 0.5 
...
#funcionando perfect - talvez deixar generico com classes
a = Read_sonar_dataset(distance_filter=False)
a.cod_principal()